...
function consultx_customize_register( $wp_customize ) {	
	...
	$wp_customize->add_panel( 'consultx_panel_area', array(
		...
		'theme_supports' => '',
		'title' => esc_html__( 'Theme Options Panel', 'consultx' ),		
	) );
	...
	$wp_customize->add_setting('consultx_hover_color_scheme',array(
		'default' => '#8f2817',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	
	$wp_customize->add_control(
		new WP_Customize_Color_Control($wp_customize,'consultx_hover_color_scheme',array(
			'label' => esc_html__('Hover Color Scheme','consultx'),		
			'section' => 'colors',
			'settings' => 'consultx_hover_color_scheme'
		))
	);
	...
	$wp_customize->add_control('consultx_header_email',array(	
		'type' => 'text',
		'label' => esc_html__('Add E-mail here','consultx'),
		'section' => 'consultx_hdr_contact_section',
	...
	$wp_customize->add_setting('consultx_show_breadcrumb_info',array(
		'default' => false,
		'sanitize_callback' => 'consultx_sanitize_checkbox',
		'capability' => 'edit_theme_options',
	));	 
	
	$wp_customize->add_control( 'consultx_show_breadcrumb_info', array(
	   'settings' => 'consultx_show_breadcrumb_info',
	   'section'   => 'consultx_hdr_contact_section',
	   'label'     => esc_html__('Check To show Breadcrumb Section','consultx'),
	   'type'      => 'checkbox'
	 ));//Show header contact info
	...
	$wp_customize->add_section( 'consultx_slide_panelarea', array(
		...
		'priority' => null,
		'description' => esc_html__('Default image size for slider is 1400 x 633 pixel.','consultx'), 
		'panel' => 	'consultx_panel_area',           			
    ));
	...
	$wp_customize->add_section('consultx_current_project_section', array(
		...
		'description' => esc_html__('Select pages from the dropdown for current project section','consultx'),
		'priority' => null,
		'panel' => 	'consultx_panel_area',          
	));	
	...
	$wp_customize->add_section('consultx_client_section', array(
		...
		'description' => esc_html__('Select pages from the dropdown for our partner section','consultx'),
		'priority' => null,
		'panel' => 	'consultx_panel_area',          
	));	
	
	$wp_customize->add_setting('consultx_client_tittletext',array(
		'default' => null,
		'sanitize_callback' => 'sanitize_text_field'	
	));
...
?>
	<style type="text/css"> 					
		...
		.footer-wrapper ul li.current_page_item a        				
            { color:<?php echo esc_html( get_theme_mod('consultx_color_scheme','#c1331b')); ?>;}					 
        ...
        .toggle a	
            { background-color:<?php echo esc_html( get_theme_mod('consultx_color_scheme','#c1331b')); ?>;}
		...
		blockquote	        
            { border-color:<?php echo esc_html( get_theme_mod('consultx_color_scheme','#c1331b')); ?>;}	
 ...
 */
function consultx_customize_preview_js() {
	wp_enqueue_script( 'consultx_customizer', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20191002', true );
}
add_action( 'customize_preview_init', 'consultx_customize_preview_js' );